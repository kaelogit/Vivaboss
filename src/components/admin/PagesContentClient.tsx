...
import type { PagesContent } from "@/lib/content/siteSettings";
...
export default function PagesContentClient() {
        ...
        <form onSubmit={onSave} className="space-y-6">
          ...
          <section className="border border-vb-line bg-vb-white p-5 sm:p-6">
            <div className="space-y-4">
              <div>
                <label className={labelClass}>About intro</label>
                <textarea
                  className={areaClass}
                  rows={4}
              ...
              <div>
                <label className={labelClass}>Contact intro</label>
                <textarea
                  className={areaClass}
                  rows={4}
                  value={content.contactIntro}
                  onChange={(e) =>
                    setContent({ ...content, contactIntro: e.target.value })
                  }
                />
              </div>
              <div>
                <label className={labelClass}>
                  Announcement (optional — leave blank to hide)
                </label>
                <textarea
                  className={areaClass}
                  rows={2}
                  ...
                  onChange={(e) =>
                    setContent({ ...content, announcement: e.target.value })
                  }
                />
              </div>
            </div>
